    ...
    <section className="section-shell relative overflow-hidden py-14 md:py-20">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <ScrollReveal delay={0.3}>
          <Link
            href="/careers"
            className="mt-10 inline-flex items-center gap-2 rounded-full bg-neon px-10 py-4 text-sm font-bold uppercase tracking-wide text-white transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_30px_rgba(217,70,239,0.4)]"
          >
            View Open Roles
            <ArrowRight size={16} />
          </Link>
