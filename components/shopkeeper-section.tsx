  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, rgba(76, 29, 149, 0.015) 30%, rgba(76, 29, 149, 0.015) 70%, transparent 100%)",
        }}
        aria-hidden="true"
      />
                ...
                <ScrollReveal key={feature.title} delay={0.08 * (i + 1)}>
                  <div className="motion-panel group relative h-full overflow-hidden rounded-2xl border border-border/50 bg-surface/80 p-7 backdrop-blur-sm transition-all duration-500 hover:border-neon/40">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "radial-gradient(circle at top left, rgba(76,29,149,0.05) 0%, transparent 60%)",
                      }}
                      aria-hidden="true"
                    />
