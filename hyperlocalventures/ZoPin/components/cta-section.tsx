  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(76, 29, 149, 0.08) 0%, transparent 60%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
            Partner with{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-neon to-accent animate-gradient-x neon-text-glow">ZoPin</span>
          </h2>
        </ScrollReveal>
            ...
            {submitSuccess ? (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-full bg-neon px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(217,70,239,0.45)] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
